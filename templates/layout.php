...
<head>
  ...
  <!-- Favicons -->
  <link href="templates/assets/img/section7.png" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">SECTION<span>7</span></a></h1>
      ...
      <a href="templates/admin/login.php" class="get-started-btn scrollto">Connexion</a>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>Section<span>7</span></h3>
              <p>
                Dakar <br>
                Ouest-foire yf-594<br><br>
                <strong>Phone:</strong> +221 776731802<br>
                <strong>Email:</strong> coulybaly.alf@gmail.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Alf-Tech</span></strong>. Tous les droits sont réservés
      </div>
      <div class="credits">
        Designed by <a href="www.alf-tech.net">Alf-Tech</a>
      </div>
    </div>
  </footer><!-- End Footer -->
